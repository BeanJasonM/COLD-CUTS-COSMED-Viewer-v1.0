...
The easiest version is the Streamlit app in `app.py`. It gives you simple buttons, upload controls, sidebar settings, tabs, tables, and plots. The Jupyter notebook is still included as an optional learning version.
